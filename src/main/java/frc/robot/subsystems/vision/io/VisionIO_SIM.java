...
public class VisionIO_SIM implements VisionIO {
    ...
    public VisionResult[] getMeasurements() {
        ...
        for (int i=0; i<simCameras.length; i++) {
            ...
            //     if (pose.isPresent()) {
            //         visionMeasurements[i] = new VisionResult(pose.get().estimatedPose, result.getTimestampSeconds());
            //     }
            // }
	...
	public void update(Pose2d pose) {
        Logger.recordOutput("Cameras/Inputted Pose", pose );
        ...
        Logger.recordOutput("Cameras/Camera Locations", GeneralConstants.CameraTransforms);
	}
